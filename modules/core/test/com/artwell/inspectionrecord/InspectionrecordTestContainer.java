package com.artwell.inspectionrecord;
...
public class InspectionrecordTestContainer extends TestContainer {

    public InspectionrecordTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/artwell/inspectionrecord/app.properties",
    ...
    public static class Common extends InspectionrecordTestContainer {

        public static final InspectionrecordTestContainer.Common INSTANCE = new InspectionrecordTestContainer.Common();
